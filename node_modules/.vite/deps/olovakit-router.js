import {
  ...
  setEffect,
  setState
} from "./chunk-EDWYJHOS.js";
import "./chunk-EQCVQC35.js";

// node_modules/olovakit-router/dist/index.js
...
function extractParams(pattern, path) {
  ...
  const paramNames = (pattern.match(/:[a-zA-Z0-9_]+/g) || []).map(
...
function Routes(props) {
  ...
  const routes = routeConfigs.filter((child) => child != null).map((child) => {
...
//# sourceMappingURL=olovakit-router.js.map
